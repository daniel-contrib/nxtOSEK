...
RXEFLASH  = flash-rxe-app.sh
RAMBOOT   = ramboot-app.sh
...
LDFLAGS = -mthumb -mthumb-interwork -Wl,--allow-multiple-definition -Wl,-Map,$(basename $@).map -Wl,--cref -Wl,--gc-sections --specs=nosys.specs \
